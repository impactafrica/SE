...
const dict = {
    ...
    "Access: While starting out, it is imperative that you deal directly with customers, hence it is important you ask yourself this"
    :
    <div>
    ...
    "Reason to buy: Does your target customer have a compelling and valid reason to buy your product?"
    :
    <div>
          <Typography >
          <br></br>
    ...
    "Can you deliver a full product?  Is it within your scope to deliver a fully functional solution with or without partners? Is your product complete and can it offer a singular holistic solution to the end user’s challenges and /or needs?"
    :
    <div>
          <Typography >
          <br></br>
    ...
    "Competition is inevitable. At any given point competitors are trying to win over market segments similar to yours. Take some time to understand where the competition exists, how they can be a blocker to you and your product and where your competitive advantage is. "
    :
    <div>
          <Typography >
          <br></br>
...
"Does this market segment stay consistent and align itself to your brand i.e values, passion and goals? It is paramount that you stay within brand."
:
<div>
      <Typography >
      <br></br>
